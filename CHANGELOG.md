...
- общий селектор кабинета показывает состояние свежести на всех аналитических разделах и обновляет его без тяжёлого пересчёта дашборда через отдельный read-only маршрут;
