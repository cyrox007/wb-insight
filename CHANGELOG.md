...
- P84: административные boolean-флаги платёжных и почтовых настроек принимают только реальные JSON `true/false`; строки `"false"`, `"0"` и другие неявные значения больше не преобразуются в `True`;
