...
- клиентский кеш кабинетов изолирован между сессиями: при выходе список, выбранный кабинет и локальное состояние очищаются, а запоздалый ответ предыдущей сессии не может восстановить старые данные;
