...
- затронутые auth/password validation messages приведены к русскому системному контракту, regression-тесты отделяют input-validation от атомарности регистрации.
