...
async function saveUser() {
	...
	try {
		const payload = {
			...
			kpp: userData.value.entity_type === 'legal_entity' ? (userData.value.kpp.trim() || null) : null,
			legal_address: userData.value.entity_type === 'legal_entity' ? (userData.value.legal_address.trim() || null) : null,
